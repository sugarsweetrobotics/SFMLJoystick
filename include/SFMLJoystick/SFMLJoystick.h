  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  SFMLJoystick(RTC::Manager* manager);
 ...
 protected:
   ...
   * PovX, PovY.
   */
  OutPort<RTC::TimedLongSeq> m_axisOut;
...
extern "C"
{
  DLL_EXPORT void SFMLJoystickInit(RTC::Manager* manager);
};

#endif // SFMLJOYSTICK_H
